	...
	<header id="header" class="bootstrap">
		<nav id="header_infos" role="navigation">
			<div class="navbar-header">
				...
				<a id="header_shopname" href="{$default_tab_link|escape:'html':'UTF-8'}" style="padding-left: 90px !important">
					<img width="100px" src="{$img_dir}prestashop-avatar.png" alt="{$shop_name|escape:'html':'UTF-8'}" />
